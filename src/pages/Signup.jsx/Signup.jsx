  ...
  return (
    ...
    <Helmet>
      ...
      <h1 className='text-xl text-slate-700 font-semibold mb-5'>
        <i className='fa-regular fa-circle-user me-2'></i> Register Now
      </h1>
      <form className='space-y-3' onSubmit={formik.handleSubmit}>
        <div className="name">
          <input type="text" className='form-control w-full' placeholder='Type your name' value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur} name='name'/>
        ...
        <div className="rePassword">
          <input type="password" className='form-control w-full' placeholder='Confirm password' value={formik.values.rePassword} onChange={formik.handleChange} onBlur={formik.handleBlur} name='rePassword'/>
          {formik.errors.rePassword && formik.touched.rePassword && (<p className='text-red-500 mt-1 text-sm'>*{formik.errors.rePassword}</p>)}
        </div>
        <div className="phone">
          <input type="tel" className='form-control w-full' placeholder='Phone Number' value={formik.values.phone} onChange={formik.handleChange} onBlur={formik.handleBlur} name='phone'/>
